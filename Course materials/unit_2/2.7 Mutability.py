...
#----------------------------------------------------------------------------
# Demonstrates that mutable objects can have multiple names, we creat this list
# first_list and we put second_list refrencing this list, even though there are
# two variables, there is only one object list
# first_list = [1,2,3,4,5]
# second_list = first_list
# second_list[0] = 1000
# print("first_list now has the value",first_list)

# This part is my own code 1 which gives x = [1,2,3,4,5]
# a = 1; b =2; c =3; d =4; e =5;
# x = [a,b,c,d,e]
# a = 10
# print(x)
